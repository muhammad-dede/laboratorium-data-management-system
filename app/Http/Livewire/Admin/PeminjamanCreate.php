...
class PeminjamanCreate extends Component
{
    ...
    public $id_siswa, $id_jadwal_praktek;
    ...
    {
        $this->data_jadwal_praktek = JadwalPraktek::all();
    ...
    {
        return view('livewire.admin.peminjaman-create');
    }

    public function updatedIdJadwalPraktek()
    {
        $jadwal_praktek = JadwalPraktek::where('id_jadwal_praktek', $this->id_jadwal_praktek)->first();
        $this->data_siswa = Siswa::where('id_kelas', $jadwal_praktek->id_kelas)->get();
        $this->id_siswa = null;
    }
