<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('guru.beranda') }}" class="brand-link elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="{{ route('guru.beranda') }}" class="nav-link {{ $menu == 'beranda' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('guru.peminjaman.index') }}"
                        ...
                        <p>
                            Peminjaman
                            @if (acc_peminjaman() > 0)
                                <span class="badge badge-danger right">{{ acc_peminjaman() }}</span>
                            @endif
                        </p>
                    </a>
                </li>
