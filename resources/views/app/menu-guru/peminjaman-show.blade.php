        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="{{ route('guru.peminjaman.index') }}" class="btn btn-danger float-sm-right">Kembali</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <form action="{{ route('guru.peminjaman.acc', $peminjaman) }}" method="POST" role="alert"
                                alert-title="ACC Peminjaman" alert-text="Yakin Ingin ACC Peminjaman Alat?">
                                @csrf
                                @method('put')
                                <div class="row">
