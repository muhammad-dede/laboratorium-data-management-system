                                ...
                                <form action="{{ route('alat.update', $alat) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="satuan" id="satuan"
                                            ...
                                            <option value="PCS" {{ $alat->satuan == 'PCS' ? 'selected' : '' }}>
                                                PCS</option>
                                            <option value="SET" {{ $alat->satuan == 'SET' ? 'selected' : '' }}>
                                                SET</option>
                                            <option value="UNIT" {{ $alat->satuan == 'UNIT' ? 'selected' : '' }}>
                                                UNIT</option>
                                        </select>
                                        @error('satuan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <select name="id_rak" id="id_rak"
                                            ...
                                            @foreach ($data_rak as $rak)
                                                <option value="{{ $rak->id_rak }}"
                                                    {{ $alat->id_rak == $rak->id_rak ? 'selected' : '' }}>
